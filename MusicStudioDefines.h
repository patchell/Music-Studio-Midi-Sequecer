...
enum class MouseRegionTransitionState : int{
	...
	MOUSE_TRANSITION_OUTSIDE_TO_LAST_EDIT,
	MOUSE_TRANSITION_OUTSIDE_TO_LOWER_DRAW,
	MOUSE_TRANSITION_OUTSIDE_TO_UPPER_DRAW,
	//---------------- UPPER DRAW TO ... ---------------
	MOUSE_TRANSITION_UPPER_DRAW_TO_EDIT,
	MOUSE_TRANSITION_UPPER_DRAW_TO_LAST_EDIT,
	MOUSE_TRANSITION_UPPER_DRAW_TO_OUTSIDE,
	MOUSE_TRANSITION_UPPER_DRAW_TO_UPPER_SEL,
	//------------- LOWER_DRAW TO ... ------------------
	MOUSE_TRANSITION_LOWER_DRAW_TO_EDIT,
	MOUSE_TRANSITION_LOWER_DRAW_TO_LAST_EDIT,
	MOUSE_TRANSITION_LOWER_DRAW_TO_OUTSIDE,
	MOUSE_TRANSITION_LOWER_DRAW_TO_LOWER_SEL,
	//--------------LASTEDIT TO ... -----------------
	MOUSE_TRANSITION_LASTEDIT_TO_UPPER_SEL,
	MOUSE_TRANSITION_LASTEDIT_TO_LOWER_DRAW,
	MOUSE_TRANSITION_LASTEDIT_TO_OUTSIDE,
	MOUSE_TRANSITION_LASTEDIT_TO_EDIT,
	MOUSE_TRANSITION_LASTEDIT_TO_UPPER_DRAW,
	MOUSE_TRANSITION_LASTEDIT_TO_LOWER_SEL,
	//-------------------------------
