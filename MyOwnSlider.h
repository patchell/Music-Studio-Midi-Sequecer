...
enum {
	MYOWNSLIDER_NOARROW_CLICKED = -1,
	MYOWNSLIDER_ARROW_LEFT = 0,
	MYOWNSLIDER_ARROW_RIGHT,
	MYOWNSLIDER_TIMERID_LEFTARROW = 4000,
	MYOWNSLIDER_TIMERID_RIGHTARROW,
	MYOWNSLIDER_TIMERID_LBUTTON_DOWN_TIMER,
};
