...
enum {
	...
	//-----------
	DX7_CONTROL_ID_EG_SEGMENT_LEVEL_1 = 801,
	DX7_CONTROL_ID_EG_SEGMENT_LEVEL_2,
	DX7_CONTROL_ID_EG_SEGMENT_LEVEL_3,
	DX7_CONTROL_ID_EG_SEGMENT_LEVEL_4,
	DX7_CONTROL_ID_EG_SEGMENT_RATE_1,
	DX7_CONTROL_ID_EG_SEGMENT_RATE_2,
	DX7_CONTROL_ID_EG_SEGMENT_RATE_3,
	DX7_CONTROL_ID_EG_SEGMENT_RATE_4,
	DX7_CONTROL_ID_KEYBOARD_LEVEL_SCALING_BREAKPOINT,
	DX7_CONTROL_ID_KEYBOARD_LEVEL_SCALING_LEFT_DEPTH,
	DX7_CONTROL_ID_KEYBOARD_LEVEL_SCALING_RIGHT_DEPTH,
	DX7_CONTROL_ID_KEYBOARD_LEVEL_SCALING_LEFT_CURVE,
	DX7_CONTROL_ID_KEYBOARD_LEVEL_SCALING_RIGHT_CURVE,
	DX7_CONTROL_ID_KEYBOARD_RATE_SCALING,
	DX7_CONTROL_ID_AMPLITUDE_MODULATION_SENSITIVITY,
	DX7_CONTROL_ID_KEY_VELOCITY_SENSITIVITY,
	DX7_CONTROL_ID_OPERATOR_OUTPUT_LEVEL,
	DX7_CONTROL_ID_OSCILLATOR_MODE,
	DX7_CONTROL_ID_OSCILLATOR_FREQUENCY_COARSE,
	DX7_CONTROL_ID_OSCILLATOR_FREQUENCY_FINE,
	DX7_CONTROL_ID_OSCILLATOR_DETUNE,
	//-------------------------
	// operator common control IDs
	//-------------------------
	DX7_CONTROL_EG_PITCH_ID_RATE_1,
	DX7_CONTROL_EG_PITCH_ID_RATE_2,
	DX7_CONTROL_EG_PITCH_ID_RATE_3,
	DX7_CONTROL_EG_PITCH_ID_RATE_4,
	DX7_CONTROL_EG_PITCH_ID_LEVEL_1,
	DX7_CONTROL_EG_PITCH_ID_LEVEL_2,
	DX7_CONTROL_EG_PITCH_ID_LEVEL_3,
	DX7_CONTROL_EG_PITCH_ID_LEVEL_4,

	DX7_CONTROL_ID_ALGORITHM_SELECT,
	DX7_CONTROL_ID_FEEDBACK,
	DX7_CONTROL_ID_OSCILLATOR_KEY_SYNC,
	DX7_CONTROL_ID_LFO_SPEED,
	DX7_CONTROL_ID_LFO_DELAY,
	DX7_CONTROL_ID_LFO_PITCH_MODULATION_DEPTH,
	DX7_CONTROL_ID_LFO_AMPLITUDE_MODULATION_DEPTH,
	DX7_CONTROL_ID_LFO_KEY_SYNC,
	DX7_CONTROL_ID_LFO_WAVEFORM,
	DX7_CONTROL_ID_LFO_PITCH_MODULATION_SENSITIVITY,
	DX7_CONTROL_ID_TRANSPOSE,
	//----------------------------------
	// PERFORMANCE CONTROL IDs
	//----------------------------------
	DX7_CONTROL_ID_MIDICHAN_SELECT,
	DX7_CONTROL_ID_POLY_MONO,

	DX7_CONTROL_ID_PITCH_BEND_RANGE,
	DX7_CONTROL_ID_PITCH_BEND_STEP,

	DX7_CONTROL_ID_PORTAMENTO_TIME,
	DX7_CONTROL_ID_PORTAMENTO_GLISANDO,
	DX7_CONTROL_ID_PORTAMENTO_MODE,

	DX7_CONTROL_ID_MODULATION_WHEEL_SENSITIVITY,
	DX7_CONTROL_ID_MODULATION_WHEEL_ASSIGN_EGBIAS,
	DX7_CONTROL_ID_MODULATION_WHEEL_ASSIGN_AMPLITUDE,
	DX7_CONTROL_ID_MODULATION_WHEEL_ASSIGN_PITCH,

	DX7_CONTROL_ID_FOOT_CONTROL_SENSITIVITY,
	DX7_CONTROL_ID_FOOT_CONTROL_ASSIGN_EGBIAS,
	DX7_CONTROL_ID_FOOT_CONTROL_ASSIGN_AMPLITUDE,
	DX7_CONTROL_ID_FOOT_CONTROL_ASSIGN_PITCH,

	DX7_CONTROL_ID_AFTER_TOUCH_SENSITIVITY,
	DX7_CONTROL_ID_AFTER_TOUCH_ASSIGN_EGBIAS,
	DX7_CONTROL_ID_AFTER_TOUCH_ASSIGN_AMPLITUDE,
	DX7_CONTROL_ID_AFTER_TOUCH_ASSIGN_PITCH,

	DX7_CONTROL_ID_BREATH_CONTROLLER_SENSITIVITY,
	DX7_CONTROL_ID_BREATH_CONTROLLER_ASSIGN_EGBIAS,
	DX7_CONTROL_ID_BREATH_CONTROLLER_ASSIGN_AMPLITUDE,
	DX7_CONTROL_ID_BREATH_CONTROLLER_ASSIGN_PITCH,

	DX7_CONTROL_ID_MASTER_TUNING,
	//buttons
	DX7_BUTTON_ID_NEXT,
	DX7_BUTTON_ID_PREV,
	DX7_BUTTON_ID_HOME,
...
enum {
	DX7_ALG_RECT = 0X1000,		//Point x,y Size cx,cy
	DX7_ALG_RECT_LINE_COLOR,
	DX7_ALG_RECT_FILL_COLOR,
	DX7_ALG_TEXT_LOCATION,
	DX7_ALG_TEXT_COLOR,
	DX7_ALG_TEXT_CHARACTER,
	DX7_ALG_LINE,				//Point1 x,y  Point2 x,y
	DX7_ALG_LINE_COLOR,
	DX7_ALG_BACKGROUND_COLOR,
	DX7_ALG_STRING_ADD_CHAR,
	DX7_ALG_STRING
};
...
enum {
	DX7_DRAWMODE_ALG,
	DX7_DRAWMODE_OPERATOR_1,
	DX7_DRAWMODE_OPERATOR_2,
	DX7_DRAWMODE_OPERATOR_3,
	DX7_DRAWMODE_OPERATOR_4,
	DX7_DRAWMODE_OPERATOR_5,
	DX7_DRAWMODE_OPERATOR_6,
	DX7_DRAWMODE_COMMON,
	DX7_DRAWMODE_PERFORMANCE,
};

enum OperatorIndexValue {
	DX7_INDEX_OP_6,
	DX7_INDEX_OP_5,
	DX7_INDEX_OP_4,
	DX7_INDEX_OP_3,
