...
constexpr auto NOTE_POS_C2 = STAVE_LINE_SPACING + NOTE_POS_E2;
constexpr auto NOTE_POS_C4 = STAVE_LINE_SPACING * 6 + NOTE_POS_A5;
//-------------------------------
...
public:
	...
	inline static RangeItem RangeItemLUT[6] = {
		{ -36, "C-1 -> C3" },
		{ -24, "C0 -> C4" },
		{ -12, "C1 -> C5" },
		{ 0, "C2 -> C6" },
